...
export class StreamConfigurationService {
  ...
  private static infrastructure: BroadcastInfrastructure = {
    primaryServer: process.env.RRB_PRIMARY_SERVER || 'listen.181fm.com',
    backupServer: process.env.RRB_BACKUP_SERVER || 'ice5.somafm.com',
    cdn: process.env.RRB_CDN || 'stream.radioparadise.com',
    transcoding: true,
    ...
    const defaultStreams: StreamConfig[] = [
      {
        ...
        type: 'radio',
        streamUrl: process.env.RRB_MAIN_STREAM || 'http://listen.181fm.com/181-rnb_128k.mp3',
        backupUrl: process.env.RRB_MAIN_BACKUP || 'https://ice5.somafm.com/groovesalad-128-mp3',
        protocol: 'hls',
        bitrate: 128,
        format: 'aac',
        sampleRate: 44100,
      ...
      },
      {
        ...
        type: 'video',
        streamUrl: process.env.RRB_VIDEO_STREAM || 'https://meet.jit.si/RRBLiveStudio',
        protocol: 'dash',
        bitrate: 2500,
        format: 'h264',
        sampleRate: 48000,
      ...
      },
      {
        ...
        type: 'podcast',
        streamUrl: process.env.RRB_PODCAST_FEED || 'https://npr-ice.streamguys1.com/live.mp3',
        protocol: 'http',
        bitrate: 64,
        format: 'mp3',
        sampleRate: 44100,
      ...
      },
      {
        ...
        type: 'commercial',
        streamUrl: process.env.RRB_COMMERCIAL_FEED || 'http://listen.181fm.com/181-beat_128k.mp3',
        protocol: 'http',
        bitrate: 128,
        format: 'aac',
        sampleRate: 44100,
