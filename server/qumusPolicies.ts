...
export const POLICY_REGISTRY = [
  ...
  { id: 'content_scheduling', name: 'Content Scheduling', category: 'ecosystem' as const, description: 'Auto-schedules broadcasts, rotates content across 54 RRB channels 24/7', autonomyLevel: 90 },
