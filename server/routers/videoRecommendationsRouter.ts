      ...
      const mockRecommendations = [
        {
          ...
          thumbnail: "https://via.placeholder.com/300x200?text=Urban+Cinematic",
        ...
        },
        {
          ...
          thumbnail: "https://via.placeholder.com/300x200?text=Motion+Graphics",
        ...
        },
        {
          ...
          thumbnail: "https://via.placeholder.com/300x200?text=Abstract+Colors",
      ...
      const mockTrending = [
        {
          ...
          likeCount: 8900,
          createdAt: new Date(Date.now() - 86400000),
          thumbnail: "https://via.placeholder.com/300x200?text=Viral+Cinematic",
          creator: "TopCreator",
          rank: 1,
        },
        {
          ...
          likeCount: 7200,
          createdAt: new Date(Date.now() - 172800000),
          thumbnail: "https://via.placeholder.com/300x200?text=Mind+Bending",
      ...
      const mockSimilar = [
        {
          ...
          thumbnail: "https://via.placeholder.com/300x200?text=Similar+1",
        ...
        },
        {
          ...
          thumbnail: "https://via.placeholder.com/300x200?text=Similar+2",
