 ...
 * Generates AI DJ-voiced commercial scripts and manages rotation across 54 channels
 */
...
export const UN_CAMPAIGN_COMMERCIALS: CampaignCommercial[] = [
  ...
  {
    id: 'un-rrb-bumper-15',
    title: 'RRB Radio — 54 Channels, One Mission',
    category: 'bumper',
    djVoice: 'seraph',
    script: `You're listening to Rockin' Rockin' Boogie Radio — 54 channels strong. Sweet Miracles and Rockin' Rockin' Boogie — building the bridge across the world. Powered by QUMUS. Built by Canryn Production. March 17th — we take it to the United Nations. Stay tuned.`,
    duration: 15,
    priority: 10,
