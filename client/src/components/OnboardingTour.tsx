...
const tourSteps: TourStep[] = [
  {
    ...
    description: 'The autonomous brain of the entire ecosystem. QUMUS orchestrates 20 active policies, manages 18 subsystems, and maintains 90% autonomous control with human override capabilities.',
    icon: Monitor,
    iconColor: 'text-violet-400',
    iconBg: 'bg-violet-500/20',
    path: '/qumus',
    features: ['20 Active Policies', '18 Subsystems', '90% Autonomous', 'Real-time Health Monitoring'],
  },
  {
    id: 'ai-chat',
