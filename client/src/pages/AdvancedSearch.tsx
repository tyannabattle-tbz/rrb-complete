...
export default function AdvancedSearch() {
  ...
  const searchMutation = trpc.advancedSearch.search.useQuery(
  ...
  const searchTrigger = trpc.advancedSearch.search.useQuery;
  const suggestionQuery = trpc.advancedSearch.getSuggestions.useQuery(
    { query, limit: 5 },
