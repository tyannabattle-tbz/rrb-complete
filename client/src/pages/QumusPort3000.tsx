...
import { CrossPortNavigation } from '@/components/CrossPortNavigation';
...
export default function QumusPort3000() {
  ...
  return (
    <>
      <CrossPortNavigation currentPort={3000} />
        ...
        <footer className="border-t border-purple-500/20 bg-slate-900/50 mt-16 py-8">
          <div className="container mx-auto px-4 text-center text-purple-300">
            ...
            <p className="text-sm mt-2">
              <a href="http://localhost:3001" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400">RRB (3001)</a> • 
              <a href="http://localhost:3002" target="_blank" rel="noopener noreferrer" className="hover:text-red-400">HybridCast (3002)</a>
            </p>
          </div>
        </footer>
      </div>
