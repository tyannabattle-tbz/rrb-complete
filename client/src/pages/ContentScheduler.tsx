          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Autonomous content scheduling across 54 channels</p>
              </div>
            </div>
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        {scheduleQuery.isLoading ? (
          ...
          <Card className="bg-slate-800/50 border-purple-500/10">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-sm text-slate-400 mb-4">Click "Seed Default Schedule" to populate all 54 channels with 24/7 content</p>
        ...
        <footer className="text-center py-4 border-t border-purple-500/10">
          <p className="text-xs text-slate-500">
            QUMUS Content Scheduler • 54 Channels • 24/7 Autonomous Programming • A Canryn Production
          </p>
        </footer>
      </main>
    </div>
