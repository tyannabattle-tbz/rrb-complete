...
import { djNotificationService } from '@/lib/djNotificationService';

export default function RadioStationFinal() {
        ...
        <Card className="bg-gradient-to-r from-purple-600 to-pink-600 border-0 p-6 mb-8 text-white">
          ...
          <div className="flex items-center gap-4 mb-4">
            <Button
              ...
              className="bg-white text-purple-600 hover:bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center"
            >
            ...
            <Button
              ...
              variant={favorites.has(selectedChannel.id) ? 'default' : 'outline'}
            ...
            return (
              <Card
                ...
                className={`bg-slate-800 border-slate-700 p-4 cursor-pointer transition-all hover:border-purple-500 ${
                  selectedChannel.id === channel.id ? 'border-purple-500 ring-2 ring-purple-500' : ''
                }`}
