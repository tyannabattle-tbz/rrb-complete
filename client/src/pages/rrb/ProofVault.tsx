...
const proofItems: ProofItem[] = [
  ...
  },
  {
    ...
    title: 'Wikipedia — Candy Hunter on Two Little Richard Pages',
    category: 'digital',
    description: 'Seabrun "Candy" Hunter is credited on TWO separate Wikipedia pages: the main Little Richard biography and The Second Coming album page, where he is listed as co-writer of "Rockin\' Rockin\' Boogie" (Penniman, Seabrun Hunter).',
    verificationStatus: 'verified',
    source: 'Wikipedia — Little Richard & The Second Coming (Little Richard album)',
    details: [
      'Little Richard main page states: "He worked on new songs with sideman Seabrun \'Candy\' Hunter"',
      'The Second Coming album page lists Track 6: "Rockin\' Rockin\' Boogie" (Penniman, Seabrun Hunter) — 5:28',
      'Album recorded 27 March – 12 April 1972 at Record Plant, Los Angeles, released September 1972 on Reprise Records',
      'Produced by Richard Penniman and Robert "Bumps" Blackwell',
      'Wikipedia edit was made by Phil Silverman, who confirmed this in email correspondence',
      'Both articles are publicly accessible to billions — establishing Candy Hunter in the permanent historical record',
    ],
    externalLinks: [
      { label: 'Little Richard — Wikipedia', url: 'https://en.wikipedia.org/wiki/Little_Richard' },
      { label: 'The Second Coming (album) — Wikipedia', url: 'https://en.wikipedia.org/wiki/The_Second_Coming_(Little_Richard_album)' },
    ],
    significance: 'Wikipedia is the world\'s most-accessed reference source. Candy Hunter appears on TWO separate pages — the main Little Richard biography and The Second Coming album track listing — establishing his name as co-writer in the permanent, globally accessible historical record.',
  },
  {
  ...
  },
  {
    ...
    details: [
      ...
      'Note: Audio recording exists but withheld pending review of mediation confidentiality agreement — Missouri is a one-party consent state',
    ],
  ...
  },
  {
    ...
    screenshotGallery: [
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/kHPnqdCsTjvrwAyg.jpg', caption: '"Miracles" Volume One — Book cover by Seabrun Candy Hunter' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/PfSaoKQPRWnVIdEd.jpg', caption: 'Biography page — Seabrun Candy Hunter, Architect of Rock' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/BwZzNdTYFYxUiyBl.jpg', caption: 'Little Richard\'s written endorsement for Candy Hunter\'s project' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/vWBeKZxmWtnkQByq.jpg', caption: 'Alvin Taylor Music shares Candy Hunter quote about friendship (Jul 2017)' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/pebMNaesKjiUcmFd.PNG', caption: '"Miracles" book cover — website screenshot' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/dkXAPbkhEUJtoYhS.PNG', caption: 'Candy Hunter biography — life and career with Little Richard' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/FPZswRgtcChkmdzG.PNG', caption: 'Little Richard\'s endorsement for Seabrun Whitney Hunter Jr.' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/QQAztkOIaPZnGYVq.PNG', caption: 'Handwritten book dedication from Dad (Seabrun) to TyAnna' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/yRikBQUkUBdrqfJl.PNG', caption: 'Book dedication to the women in his life — Valerie E. Caldwell' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/HQZwrnGycrTnzRZd.PNG', caption: '"A Collection of 50 Love Poems" — book cover by Candy Hunter' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/CpCSxZuvJWwiAiyu.PNG', caption: 'Last Will and Testament of Seabrun Whitney Hunter Jr. (Jan 2022)' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/EMQqbtYWSuutUqqE.PNG', caption: 'Will excerpt — Seabrun names Paulina as successor' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/wjKDOuzPEEhSCwqz.PNG', caption: 'Email from Paulina C. Nordhaus — referenced as supposed will (Aug 2017)' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/PPvJlAVLFekncWtN.PNG', caption: '"Good-bye" document cover from Miracles One book' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/LhuifuVufyurMQtW.PNG', caption: '"Good-bye" poem — inside cover of Miracles One' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/NFxXeXyQlOSEWcfL.PNG', caption: 'Richard Penniman\'s "Good-bye" poem from Miracles One' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/JDOkJQIwhDnGCXjC.PNG', caption: '"Good-bye" poem — printed inside cover of Miracles One' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/TpaigSeWiiixfDIi.PNG', caption: '"Good-bye" poem continued — Miracles One book' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/xwZdjPDDtBmbKVoM.PNG', caption: '"Good-bye Cont\'d" — printed inside cover of Miracles One' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/RUaaSFqpISTPJnrR.PNG', caption: 'Candy Hunter\'s farewell poem to family and friends' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/rSQJSnLIgujOVPZC.PNG', caption: 'Candy Hunter\'s personal request from Miracles One (1972)' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/SfhppkfEolrQVnei.PNG', caption: 'Goodbye message from inside cover of Miracles One' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/CiXmsHBQiHuaWQqG.PNG', caption: 'Seabrun Hunter\'s final message to family — May 31, 2013' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/dzhouMsqUJSoaqRD.PNG', caption: 'DVD with Little Richard\'s acknowledgement — Canryn Production (Apr 2013)' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/KJBHGGBcqPLKlQvY.PNG', caption: 'Handwritten note from Dad to Thana — promotional video was a gift' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/ZemqAnijPAUSpHvq.PNG', caption: 'Alvin Taylor confirms drumming on Rockin\' Boogie, produced by HB Barnum' },
      { url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/tQWuBRlBFlzGdLFb.PNG', caption: 'Now Dig This magazine — TyAnna Battle\'s published request for memories' },
    ],
    details: [
