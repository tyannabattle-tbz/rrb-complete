  ...
  const tracks: Track[] = [
    {
      ...
      url: '/audio/rockin-rockin-boogie.mp3',
    ...
    },
    {
      ...
      url: '/audio/california-im-coming.mp3',
    ...
    },
    {
      ...
      artist: 'Seabrun Candy Hunter',
      url: '/audio/i-saw-what-you-did.mp3',
    ...
    },
    {
      ...
      artist: 'Seabrun Candy Hunter',
      url: '/audio/canryn-production-overview.wav',
