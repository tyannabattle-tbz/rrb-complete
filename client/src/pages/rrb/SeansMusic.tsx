          ...
          <div className="bg-stone-800/60 rounded-xl p-8 border border-amber-900/30 mb-12">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-shrink-0">
                <img 
                  src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663286151344/ydeZosruQsZjzMdJ.jpeg"
                  alt="Sean's Music Logo"
                  className="w-48 h-48 object-contain rounded-lg shadow-lg"
                />
              </div>
              <div className="flex-1">
                <p className="text-amber-200/80 leading-relaxed mb-4">
                  Sean's Music represents the musical vision of Seabrun Hunter, carried forward by his son Sean. 
                  The brand embodies quality production, artist development, and bringing music to audiences worldwide.
                </p>
