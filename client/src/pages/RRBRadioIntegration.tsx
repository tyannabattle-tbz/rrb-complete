...
// RRB Radio — 51 Channels: Official Station List | Canryn Production | QUMUS Orchestrated
const channels = [
  // === MUSIC (22 Stations) ===
  { id: 1, name: 'RRB Main Radio', icon: '📻', genre: 'Soul, Funk, R&B', frequency: '432 Hz', color: 'from-purple-600 to-blue-600', description: 'Soul, funk, R&B, and legacy music — the heartbeat of Canryn Production.', streamUrl: 'https://ice5.somafm.com/groovesalad-128-mp3', listeners: 127, nowPlaying: 'Community Hour with Sweet Miracles', category: 'Music' },
  { id: 5, name: 'Music Discovery', icon: '🔍', genre: 'Indie, Emerging', frequency: '432 Hz', color: 'from-violet-500 to-purple-600', description: 'New artists and deep cuts from emerging talent.', streamUrl: 'https://ice5.somafm.com/indiepop-128-mp3', listeners: 83, nowPlaying: 'Fresh Finds Friday', category: 'Music' },
  { id: 9, name: 'Gospel & Praise', icon: '🙏', genre: 'Gospel, Worship', frequency: '432 Hz', color: 'from-pink-600 to-rose-600', description: 'Gospel music, worship, and praise.', streamUrl: 'https://radio.nitro-server.uk/listen/afrofusiongospelradio/radio.mp3', listeners: 84, nowPlaying: 'Sunday Morning Praise', category: 'Music' },
  { id: 10, name: 'Smooth Jazz Lounge', icon: '🎷', genre: 'Jazz, Bebop, Fusion', frequency: '432 Hz', color: 'from-indigo-600 to-violet-600', description: 'Smooth jazz, bebop, and fusion.', streamUrl: 'https://ice5.somafm.com/fluid-128-mp3', listeners: 108, nowPlaying: 'Smooth Sax Sessions', category: 'Music' },
  ...
  { id: 14, name: 'Afrobeats Global', icon: '🥁', genre: 'Afrobeats, Amapiano', frequency: '432 Hz', color: 'from-green-500 to-emerald-600', description: 'Afrobeats, Amapiano, and African pop.', streamUrl: 'https://radio.nitro-server.uk/listen/afrofusiongospelradio/radio.mp3', listeners: 178, nowPlaying: 'Afrobeats Top Hits', category: 'Music' },
  { id: 15, name: 'Blues Highway', icon: '🎸', genre: 'Blues, Delta, Chicago', frequency: '432 Hz', color: 'from-blue-800 to-indigo-900', description: 'Delta blues, Chicago blues, and modern blues.', streamUrl: 'https://ice7.securenetsystems.net/KCSM2', listeners: 54, nowPlaying: 'Mississippi Delta Blues', category: 'Music' },
  { id: 16, name: 'Classical Serenity', icon: '🎻', genre: 'Classical, Orchestral', frequency: '432 Hz', color: 'from-amber-300 to-yellow-500', description: 'Classical orchestral and chamber music.', streamUrl: 'https://ice5.somafm.com/brfm-128-mp3', listeners: 62, nowPlaying: 'Evening Concerto', category: 'Music' },
  ...
  { id: 19, name: 'Electronic Pulse', icon: '⚡', genre: 'EDM, House, Techno', frequency: '440 Hz', color: 'from-cyan-400 to-blue-500', description: 'EDM, house, techno, and ambient.', streamUrl: 'https://ice5.somafm.com/beatblender-128-mp3', listeners: 134, nowPlaying: 'Deep House Sessions', category: 'Music' },
  { id: 20, name: 'Rock Legends', icon: '🎸', genre: 'Rock, Alternative, Indie', frequency: '440 Hz', color: 'from-red-700 to-gray-800', description: 'Classic rock, alternative, and indie rock.', streamUrl: 'https://ice5.somafm.com/metal-128-mp3', listeners: 97, nowPlaying: 'Rock Anthems', category: 'Music' },
  { id: 32, name: 'Worship & Devotional', icon: '⛪', genre: 'Worship, Devotional', frequency: '432 Hz', color: 'from-sky-600 to-blue-700', description: 'Multi-faith worship music and devotionals.', streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/KMBIFM.mp3', listeners: 48, nowPlaying: 'Morning Devotional', category: 'Music' },
  ...
  { id: 34, name: 'Women in Music', icon: '👩‍🎤', genre: 'Women Artists, All Genres', frequency: '432 Hz', color: 'from-fuchsia-500 to-pink-600', description: 'Celebrating women artists across all genres.', streamUrl: 'https://ice5.somafm.com/lush-128-mp3', listeners: 95, nowPlaying: 'Queens of Music', category: 'Music' },
  { id: 35, name: 'Indie & Underground', icon: '🎵', genre: 'Indie, Underground', frequency: '440 Hz', color: 'from-zinc-600 to-slate-700', description: 'Independent artists and underground scenes.', streamUrl: 'https://ice5.somafm.com/indiepop-128-mp3', listeners: 67, nowPlaying: 'Underground Discoveries', category: 'Music' },
  { id: 36, name: 'World Fusion', icon: '🌐', genre: 'World Music, Fusion', frequency: '432 Hz', color: 'from-teal-500 to-green-600', description: 'Global music fusion and cross-cultural sounds.', streamUrl: 'https://ice5.somafm.com/suburbsofgoa-128-mp3', listeners: 53, nowPlaying: 'Global Fusion Mix', category: 'Music' },
  ...
  // === TALK (3 Stations) ===
  { id: 2, name: 'Podcast Network', icon: '🎙️', genre: 'Podcast, Interviews', frequency: '432 Hz', color: 'from-red-500 to-pink-600', description: 'Original podcasts and interviews — In Battle Tyme and more.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 58, nowPlaying: 'In Battle Tyme', category: 'Talk' },
  ...
  { id: 41, name: 'Seraph AI Radio', icon: '🤖', genre: 'AI-Curated, Eclectic', frequency: '432 Hz', color: 'from-violet-600 to-purple-700', description: 'AI-curated music by Seraph intelligence.', streamUrl: 'https://ice5.somafm.com/secretagent-128-mp3', listeners: 183, nowPlaying: 'Seraph Selection', category: 'AI-Curated' },
  { id: 42, name: 'Candy AI Radio', icon: '🍬', genre: 'AI-Curated, Legacy, Soul', frequency: '432 Hz', color: 'from-pink-500 to-fuchsia-600', description: 'AI-curated playlists by Candy guardian.', streamUrl: 'https://ice5.somafm.com/sonicuniverse-128-mp3', listeners: 156, nowPlaying: 'Candy Legacy Mix', category: 'AI-Curated' },
  { id: 43, name: 'Valanna AI Radio', icon: '🧠', genre: 'AI-Curated, Orchestrated', frequency: '432 Hz', color: 'from-indigo-500 to-blue-600', description: 'QUMUS brain-curated intelligent programming.', streamUrl: 'https://ice5.somafm.com/lush-128-mp3', listeners: 215, nowPlaying: "Valanna's Evening Selection", category: 'AI-Curated' },
  // === WELLNESS (5 Stations) ===
  { id: 7, name: 'Drop Radio 432Hz', icon: '🧘', genre: 'Healing, Solfeggio', frequency: '432 Hz', color: 'from-green-600 to-emerald-600', description: 'Solfeggio healing frequencies — Crystal Essentials.', streamUrl: 'https://ice5.somafm.com/dronezone-128-mp3', listeners: 203, nowPlaying: '432 Hz Deep Healing Session', category: 'Wellness' },
  { id: 23, name: 'Meditation & Mindfulness', icon: '🕉️', genre: 'Meditation, Guided', frequency: '432 Hz', color: 'from-emerald-500 to-teal-600', description: 'Guided meditation and mindfulness sessions.', streamUrl: 'https://ice5.somafm.com/dronezone-128-mp3', listeners: 145, nowPlaying: 'Guided Mindfulness', category: 'Wellness' },
  { id: 27, name: 'Health & Wellness', icon: '💚', genre: 'Health, Fitness, Nutrition', frequency: '432 Hz', color: 'from-teal-500 to-cyan-600', description: 'Holistic health, fitness, and nutrition.', streamUrl: 'https://ice5.somafm.com/dronezone-128-mp3', listeners: 78, nowPlaying: 'Wellness Hour', category: 'Wellness' },
  { id: 39, name: 'Workout & Energy', icon: '💪', genre: 'Workout, Energy, Motivation', frequency: '440 Hz', color: 'from-orange-500 to-red-500', description: 'High-energy music for fitness and motivation.', streamUrl: 'https://ice5.somafm.com/beatblender-128-mp3', listeners: 167, nowPlaying: 'Power Hour', category: 'Wellness' },
  { id: 40, name: 'Sleep & Relaxation', icon: '🌙', genre: 'Sleep, Ambient, ASMR', frequency: '432 Hz', color: 'from-indigo-700 to-purple-800', description: 'Ambient sounds, sleep music, and ASMR.', streamUrl: 'https://ice5.somafm.com/dronezone-128-mp3', listeners: 134, nowPlaying: 'Deep Sleep Sounds', category: 'Wellness' },
  // === EDUCATION (3 Stations) ===
  { id: 25, name: 'Business & Finance', icon: '💼', genre: 'Business, Entrepreneurship', frequency: '440 Hz', color: 'from-slate-600 to-gray-700', description: 'Markets, entrepreneurship, and wealth building.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 45, nowPlaying: 'Market Watch', category: 'Education' },
  { id: 26, name: 'Science & Technology', icon: '🔬', genre: 'Science, Technology, AI', frequency: '440 Hz', color: 'from-blue-500 to-cyan-600', description: 'Tech trends, science discoveries, and innovation.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 38, nowPlaying: 'Tech Trends Today', category: 'Education' },
  { id: 28, name: 'Education & Learning', icon: '📚', genre: 'Education, Skills', frequency: '440 Hz', color: 'from-green-500 to-teal-500', description: 'Educational content and skill building.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 33, nowPlaying: 'Learning Hour', category: 'Education' },
  // === ENTERTAINMENT (7 Stations) ===
  { id: 3, name: 'Audiobook Stream', icon: '📖', genre: 'Audiobooks, Stories', frequency: '432 Hz', color: 'from-amber-400 to-orange-500', description: 'Narrated books and stories.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 56, nowPlaying: 'Story Hour', category: 'Entertainment' },
  { id: 21, name: 'Kids & Family', icon: '👨‍👩‍👧‍👦', genre: 'Kids, Family, Educational', frequency: '432 Hz', color: 'from-pink-400 to-purple-400', description: 'Family-friendly music and storytelling.', streamUrl: 'https://listen.radioking.com/radio/11565/stream/22961', listeners: 44, nowPlaying: 'Storytime Adventures', category: 'Entertainment' },
  ...
  { id: 30, name: 'Drama & Theater', icon: '🎭', genre: 'Drama, Radio Drama', frequency: '432 Hz', color: 'from-red-700 to-rose-800', description: 'Radio dramas, audio theater, and storytelling.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 29, nowPlaying: 'Evening Drama', category: 'Entertainment' },
  ...
  { id: 4, name: 'HybridCast Emergency', icon: '🚨', genre: 'Emergency, Public Safety', frequency: '440 Hz', color: 'from-red-700 to-red-900', description: '24/7 standby — emergency alerts and public safety.', streamUrl: 'https://ice5.somafm.com/defcon-128-mp3', listeners: 22, nowPlaying: 'All Clear — No Active Alerts', category: 'Specialty' },
  { id: 44, name: 'Ty Battle Live', icon: '🎙️', genre: 'Live, Events, Broadcast', frequency: '432 Hz', color: 'from-orange-600 to-amber-600', description: 'Live broadcasts and special events from Ty Battle.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 56, nowPlaying: 'Live Broadcast', category: 'Specialty' },
  { id: 46, name: 'Canryn Production', icon: '🎬', genre: 'Production, Studio', frequency: '432 Hz', color: 'from-amber-500 to-orange-600', description: 'Behind-the-scenes production and studio sessions.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 31, nowPlaying: 'Studio Sessions', category: 'Specialty' },
  { id: 47, name: 'Dragon Frequencies', icon: '🐉', genre: 'Frequencies, Elemental', frequency: '432 Hz', color: 'from-emerald-600 to-teal-700', description: "Wisdom's Dragon elemental frequency broadcasts.", streamUrl: 'https://ice5.somafm.com/deepspaceone-128-mp3', listeners: 45, nowPlaying: 'Dragon Healing Tones', category: 'Specialty' },
  { id: 49, name: 'Legacy Archives', icon: '🏛️', genre: 'Archives, History', frequency: '432 Hz', color: 'from-yellow-600 to-orange-600', description: 'Historical recordings, interviews, and family archives.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 29, nowPlaying: 'Voices of the Past', category: 'Specialty' },
  // === COMMUNITY (3 Stations) ===
  { id: 6, name: 'Community Voice', icon: '📞', genre: 'Community, Call-In', frequency: '432 Hz', color: 'from-blue-600 to-indigo-700', description: 'Listener stories and call-ins.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 38, nowPlaying: 'Listener Stories', category: 'Community' },
  { id: 45, name: 'Sweet Miracles', icon: '🍬', genre: 'Nonprofit, Charity', frequency: '528 Hz', color: 'from-pink-500 to-fuchsia-600', description: 'Nonprofit awareness, fundraising, and community impact (501c/508).', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 38, nowPlaying: 'Elder Advocacy Hour', category: 'Community' },
  { id: 50, name: 'Open Mic', icon: '🎤', genre: 'Open Mic, Freestyle', frequency: '432 Hz', color: 'from-amber-400 to-yellow-500', description: 'Community open mic, freestyle, and live performances.', streamUrl: 'https://ice5.somafm.com/live-128-mp3', listeners: 28, nowPlaying: 'Open Mic Night', category: 'Community' },
];
      ...
      <div className="bg-[#0D0D0D] border-b border-[#D4A843]/10">
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="relative mb-4">
            ...
            <input
              type="text"
              placeholder="Search 51 channels by name, genre, or description..."
              value={searchQuery}
