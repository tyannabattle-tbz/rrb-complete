...
const channels = [
  ...
  // === NEW CHANNELS (52-54) ===
  { id: 52, name: 'SQUADD Coalition Radio', icon: '👑', genre: 'Empowerment, Talk', frequency: '432 Hz', color: 'from-purple-600 to-fuchsia-700', description: 'SQUADD Coalition programming — Sisters Questing Unapologetically After Divine Destiny.', streamUrl: 'https://stream.zeno.fm/6ypnfbm3p8uuv', listeners: 42, nowPlaying: 'SQUADD Empowerment Hour', category: 'Community' },
  ...
  { id: 54, name: 'Canryn Production Radio', icon: '🏢', genre: 'Corporate, Updates', frequency: '432 Hz', color: 'from-amber-600 to-orange-700', description: 'Official Canryn Production updates, ecosystem news, and subsidiary highlights.', streamUrl: 'https://stream.zeno.fm/7y2e5bm3p8uuv', listeners: 31, nowPlaying: 'Ecosystem Update', category: 'Specialty' },
];
