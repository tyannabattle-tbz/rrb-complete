...
const channels = [
  ...
  // === NEW CHANNELS (52-54) ===
  { id: 52, name: 'SQUADD Coalition Radio', icon: '👑', genre: 'Empowerment, Talk', frequency: '432 Hz', color: 'from-purple-600 to-fuchsia-700', description: 'SQUADD Coalition programming — Sisters Questing Unapologetically After Divine Destiny.', streamUrl: 'https://stream.zeno.fm/6ypnfbm3p8uuv', listeners: 42, nowPlaying: 'SQUADD Empowerment Hour', category: 'Community', coverImage: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663286151344/eSHiAmKDzW4pqcyH7Ttb7c/ch52_squadd_coalition_radio-NR3GhZyxLVQoHdGHN6Lso8.webp' },
  { id: 53, name: 'UN Advocacy Radio', icon: '🌍', genre: 'Advocacy, International', frequency: '528 Hz', color: 'from-blue-700 to-indigo-800', description: 'United Nations advocacy, CSW70 coverage, and international human rights programming.', streamUrl: 'https://stream.zeno.fm/4p7t2ewfr08uv', listeners: 35, nowPlaying: 'CSW70 Coverage', category: 'Community', coverImage: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663286151344/eSHiAmKDzW4pqcyH7Ttb7c/ch53_un_advocacy_radio-QaoRfuZ5ywAyd7KzLfNzUR.webp' },
  { id: 54, name: 'Canryn Production Radio', icon: '🏢', genre: 'Corporate, Updates', frequency: '432 Hz', color: 'from-amber-600 to-orange-700', description: 'Official Canryn Production updates, ecosystem news, and subsidiary highlights.', streamUrl: 'https://stream.zeno.fm/7y2e5bm3p8uuv', listeners: 31, nowPlaying: 'Ecosystem Update', category: 'Specialty', coverImage: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663286151344/eSHiAmKDzW4pqcyH7Ttb7c/ch54_canryn_production_radio-kozFcvbMZTksygAHNvcFfq.webp' },
];
