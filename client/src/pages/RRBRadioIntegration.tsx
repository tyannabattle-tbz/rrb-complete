...
const channels = [
  ...
  // === GOSPEL & WORSHIP ===
  { id: 4, name: 'Gospel Hour', icon: '🙏', genre: 'Gospel', frequency: '528 Hz', color: 'from-pink-600 to-rose-600', description: 'Uplifting gospel and spiritual music. The Love Frequency at 528 Hz.', streamUrl: 'https://radio.nitro-server.uk/listen/afrofusiongospelradio/radio.mp3', listeners: 84, nowPlaying: 'Sunday Morning Praise', category: 'Gospel & Worship' },
  { id: 5, name: 'Praise & Worship', icon: '🕊️', genre: 'Worship', frequency: '528 Hz', color: 'from-sky-500 to-blue-600', description: 'Contemporary worship, praise anthems, and devotional music for the spirit.', streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/GNRNONSTOP.mp3', listeners: 72, nowPlaying: 'Worship Flow', category: 'Gospel & Worship' },
  ...
  { id: 7, name: 'Gospel Classics', icon: '⛪', genre: 'Gospel', frequency: '432 Hz', color: 'from-rose-700 to-red-800', description: 'Timeless gospel from Mahalia Jackson to Kirk Franklin. The roots of praise.', streamUrl: 'https://shoutcast.christianrock.net/stream/5/', listeners: 63, nowPlaying: 'Classic Gospel Greats', category: 'Gospel & Worship' },
  // === HEALING & MEDITATION ===
  ...
  { id: 17, name: 'News & Current Events', icon: '📰', genre: 'News', frequency: 'Standard', color: 'from-gray-600 to-slate-700', description: 'Community news, civil rights updates, and current events that matter.', streamUrl: 'https://tunein.cdnstream1.com/2868_96.mp3', listeners: 67, nowPlaying: 'Evening News Roundup', category: 'Talk & Community' },
  ...
  { id: 21, name: 'Blues Highway', icon: '🎸', genre: 'Blues', frequency: '432 Hz', color: 'from-blue-800 to-indigo-900', description: 'Delta blues to Chicago blues — the road that built American music.', streamUrl: 'https://ice7.securenetsystems.net/KCSM2', listeners: 54, nowPlaying: 'Mississippi Delta Blues', category: 'Jazz, Soul & Blues' },
  { id: 22, name: 'Neo Soul Lounge', icon: '🛋️', genre: 'R&B', frequency: '432 Hz', color: 'from-fuchsia-600 to-purple-700', description: 'Erykah Badu to H.E.R. — neo soul vibes for the conscious mind.', streamUrl: 'https://listen.181fm.com/181-soul_128k.mp3', listeners: 76, nowPlaying: 'Neo Soul Essentials', category: 'Jazz, Soul & Blues' },
  // === R&B & HIP-HOP ===
  { id: 23, name: 'R&B Classics', icon: '💜', genre: 'R&B', frequency: '432 Hz', color: 'from-purple-600 to-pink-600', description: 'Motown to modern R&B — love songs and slow jams across decades.', streamUrl: 'https://ais-sa1.streamon.fm/7281_64k.aac', listeners: 119, nowPlaying: 'R&B Love Songs', category: 'R&B & Hip-Hop' },
  { id: 24, name: 'Hip-Hop Nation', icon: '🎤', genre: 'Hip-Hop', frequency: 'Standard', color: 'from-red-600 to-orange-600', description: 'From the Bronx to the world — classic and conscious hip-hop.', streamUrl: 'https://streams.fluxfm.de/hiphop/mp3-320/audio/', listeners: 142, nowPlaying: 'Conscious Hip-Hop Hour', category: 'R&B & Hip-Hop' },
  { id: 25, name: 'Old School Jams', icon: '🕺', genre: 'R&B', frequency: '432 Hz', color: 'from-orange-500 to-red-600', description: "70s, 80s, 90s — the golden era of funk, disco, and R&B.", streamUrl: 'https://funkyradio.streamingmedia.it/play.mp3', listeners: 97, nowPlaying: 'Funk & Disco Classics', category: 'R&B & Hip-Hop' },
  { id: 26, name: 'Spoken Word', icon: '📝', genre: 'Spoken Word', frequency: 'Standard', color: 'from-slate-600 to-gray-700', description: 'Poetry, storytelling, and spoken word performances. Words that move.', streamUrl: 'https://stream.live.vc.bbcmedia.co.uk/bbc_world_service', listeners: 33, nowPlaying: 'Open Mic Poetry', category: 'R&B & Hip-Hop' },
  ...
  { id: 28, name: 'Afrobeats Radio', icon: '🥁', genre: 'Afrobeats', frequency: '432 Hz', color: 'from-green-500 to-emerald-600', description: 'Burna Boy, Wizkid, Tems — the sound of modern Africa.', streamUrl: 'https://radio.nitro-server.uk/listen/afrofusiongospelradio/radio.mp3', listeners: 178, nowPlaying: 'Afrobeats Top Hits', category: 'African Diaspora & Caribbean' },
  ...
  { id: 30, name: 'Caribbean Vibes', icon: '🏝️', genre: 'Caribbean', frequency: '432 Hz', color: 'from-cyan-500 to-green-500', description: 'Reggae, dancehall, soca, and calypso — island rhythms for the soul.', streamUrl: 'https://stream.zeno.fm/0r0xa792kwzuv', listeners: 87, nowPlaying: 'Reggae Roots', category: 'African Diaspora & Caribbean' },
  { id: 31, name: 'Reggae Roots', icon: '🦁', genre: 'Reggae', frequency: '432 Hz', color: 'from-yellow-600 to-green-700', description: 'Bob Marley to Chronixx — roots reggae and conscious vibes.', streamUrl: 'https://stream.zeno.fm/0r0xa792kwzuv', listeners: 73, nowPlaying: 'One Love Sessions', category: 'African Diaspora & Caribbean' },
  // === CLASSICS & LEGACY ===
  ...
  { id: 34, name: 'Motown Memories', icon: '🎹', genre: 'Classics', frequency: '432 Hz', color: 'from-blue-600 to-purple-600', description: "The Temptations, Supremes, Stevie Wonder — Motown's greatest.", streamUrl: 'https://str4uice.streamakaci.com/4umotown.mp3', listeners: 82, nowPlaying: 'Motown Greatest Hits', category: 'Classics & Legacy' },
  // === KIDS & FAMILY ===
  { id: 35, name: 'Kids & Family', icon: '👨‍👩‍👧‍👦', genre: 'Kids & Family', frequency: '432 Hz', color: 'from-pink-400 to-purple-400', description: 'Family-friendly music, stories, and educational content for all ages.', streamUrl: 'https://listen.radioking.com/radio/11565/stream/22961', listeners: 44, nowPlaying: 'Storytime Adventures', category: 'Kids & Family' },
  { id: 36, name: 'Bedtime Stories', icon: '🌜', genre: 'Kids & Family', frequency: '432 Hz', color: 'from-indigo-700 to-purple-800', description: 'Gentle stories and lullabies to help little ones drift off to sleep.', streamUrl: 'https://nl4.mystreaming.net/uber/forkidzbedtimestories/icecast.audio', listeners: 37, nowPlaying: 'Goodnight Moon', category: 'Kids & Family' },
  // === LATE NIGHT & CHILL ===
  { id: 37, name: 'Late Night Vibes', icon: '🌃', genre: 'Late Night', frequency: '432 Hz', color: 'from-slate-800 to-indigo-900', description: 'After midnight — slow jams, chill beats, and quiet storm.', streamUrl: 'https://az1.mediacp.eu/listen/airport-lounge-radio/radio.mp3', listeners: 134, nowPlaying: 'Quiet Storm', category: 'Late Night & Chill' },
  { id: 38, name: 'Lo-Fi Beats', icon: '🎧', genre: 'Lo-Fi', frequency: '432 Hz', color: 'from-slate-600 to-zinc-700', description: 'Lo-fi hip-hop beats for studying, working, and relaxing.', streamUrl: 'https://0nlineradio.radioho.st/0r-lo-fi?ref=radio-browser26', listeners: 201, nowPlaying: 'Lo-Fi Study Session', category: 'Late Night & Chill' },
  ...
  { id: 47, name: 'Throwback Radio', icon: '📼', genre: 'Classics', frequency: '440 Hz', color: 'from-orange-500 to-amber-600', description: "70s, 80s, 90s, and 2000s greatest hits — the soundtrack of every generation.", streamUrl: 'https://icecast.walmradio.com:8443/classic', listeners: 143, nowPlaying: '90s Throwback Jams', category: 'Classics & Legacy' },
  { id: 48, name: 'Love Songs', icon: '💕', genre: 'R&B', frequency: '432 Hz', color: 'from-rose-500 to-pink-600', description: 'Romantic ballads and love songs across all eras — from doo-wop to modern R&B.', streamUrl: 'https://maggie.torontocast.com:2020/stream/rdmixlovesongs', listeners: 112, nowPlaying: 'Love Ballads Hour', category: 'Jazz, Soul & Blues' },
